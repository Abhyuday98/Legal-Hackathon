<html>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="top">
        ...
        <a class="btn btn-warning btn-block" href="calculator.php" role="button">Hisab Calculator</a><br>
        <a class="btn btn-info btn-block" href="muslimdivorce.php" role="button">Juris Avenue</a><br>
